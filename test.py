...
pool = ThreadPoolExecutor(max_workers=8) #スレッドプールを1にすることで、while文に組み込んでも1つのスレッドまでしか動かない(2にして送信と受信両方のスレッドを動かすかも)
...
wav_obj = simpleaudio.WaveObject.from_wave_file("piano/1.wav")
